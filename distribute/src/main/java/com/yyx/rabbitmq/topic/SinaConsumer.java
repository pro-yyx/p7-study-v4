...
public class SinaConsumer {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(RabbitConstant.QUEUE_WEATHER_SINA, RabbitConstant.EXCHANGE_WEATHER_TOPIC,"china.sichuan.cd.20210603" );
        channel.queueBind(RabbitConstant.QUEUE_WEATHER_SINA, RabbitConstant.EXCHANGE_WEATHER_TOPIC,"china.sichuan.cd.20210602" );
        channel.queueBind(RabbitConstant.QUEUE_WEATHER_SINA, RabbitConstant.EXCHANGE_WEATHER_TOPIC,"china.sichuan.zg.20210603" );
        channel.basicQos(1);
